...
Binärformat (Frame):
    ...
    pro Sensor: [sensor_id(uint8)] + 6 floats (accX,accY,accZ,magX,magY,magZ)
...
UPDATE_INTERVAL = 8      # ~8ms = ca. 120 FPS
...
def serial_reader(ser, data_queue, running_event):
    """Thread-Funktion zum schnellen Lesen der seriellen Daten (Binary Frames)."""
    buffer = bytearray()
...
def process_data(line):
    """Verarbeitet eine Datenzeile oder Binary-Tuple mit Glaettung."""
    global sensor_data
